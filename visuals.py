...
def makecroppedpie2(file_name, label1='label1', label2='label2', value1=0, value2=0, color1='cyan', color2='blue'):
...
makecroppedpie2('gender_pie_players', 'Women', 'Men', 354, 356)
makecroppedpie2('gender_pie_winners', 'Women', 'Men', 15, 25)
