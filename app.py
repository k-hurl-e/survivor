...
def makevisuals():
    with app.app_context():
        ...
        visuals.visualmaker.makecroppedpie2('gender_pie_jury_alljury', label1='Women', label2='Men', value1=jury.juryclass.gender_jury((jury.juryclass.make_vote_dict()), 'W'), value2=jury.juryclass.gender_jury((jury.juryclass.make_vote_dict()), 'M'))
        visuals.visualmaker.makecroppedpie2('gender_pie_jury_women', label1='Women', label2='Men', value1=jury.juryclass.gender_votes((jury.juryclass.make_vote_dict()), 'w4w'), value2=jury.juryclass.gender_votes((jury.juryclass.make_vote_dict()), 'w4m'))
        visuals.visualmaker.makecroppedpie2('gender_pie_jury_men', label1='Women', label2='Men', value1=jury.juryclass.gender_votes((jury.juryclass.make_vote_dict()), 'm4w'), value2=jury.juryclass.gender_votes((jury.juryclass.make_vote_dict()), 'm4m'))
    return app
